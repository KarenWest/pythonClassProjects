...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while lettersLeft > 0:
        ...
        # Ask user for input
        orgWord = raw_input("Enter word, or a \".\" to indicate that you are finished: ")
        word = orgWord.lower() # this is optional to allow the user to enter case insensitive letters
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                totalScore += points
                print "\""+orgWord+"\" earned", points, "points. Total:", totalScore, "points"
