...
wordList = ["soft", "koala", "pink", "footballs", "Microsoft", "Reuters", "Things", "Nothing"]
...
for word in wordList:
    titleTriggerList.append(TitleTrigger(word))
    print "Appended word " + word + " to titleTriggersList"
    
i = 0
for trigger in titleTriggerList:
    #for word in wordList:
        #print "word triggering on " + word
    print "is TitleTrigger word " + trigger.word + " triggering for news story " + testSuiteNewsStory[i].title
    print trigger.evaluate(testSuiteNewsStory[i])
    i += 1
